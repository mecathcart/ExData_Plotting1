plot4 <- function(){
  ...
  house_power.f$Sub_metering_2 <- as.numeric(house_power.f$Sub_metering_2)
  ...
  with(house_power.f, plot(DateTime, Voltage, type="l", xlab = "datetime", ylab = "Voltage"))
  ...
  with(house_power.f, plot(DateTime, Global_reactive_power, type="l", xlab = "datetime", ylab = "Global_rective_power"))
